...
Tomorrow's where it gets interesting. The GFS is keeping things mostly dry through Sunday evening, maybe a hundredth or two. The Euro, ICON and GEM are all wetter, with the GEM pushing 0.07" for the Florida drainage by late evening. That's not much, but the discussion out of Grand Junction is flagging early next week as the real question. They're watching tropical moisture from a pair of hurricanes, Odalys and Polo, that could get pulled north into the Four Corners by Monday. PWATs running 200% of normal if that setup holds, and they're saying 1-3" of rain Monday through Wednesday for the southern San Juans, with localized heavier amounts possible. The Euro's more bullish on it than the GFS, and the clusters aren't lining up yet, so confidence is low on how much actually makes it here versus staying south in Arizona and New Mexico.
