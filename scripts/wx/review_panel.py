...
2. THE STAMP. The first line of the draft begins with a timestamp such as "09/25/26 5:52am:". The harness assigns it from the brief's "Open with the stamp" line, and it may differ from COMPOSED AT on purpose. Only check that it matches that stamp. Never flag it as fabricated, and never flag or demand a "late start" clause: the brief's RUNNING LATE line decides that.
